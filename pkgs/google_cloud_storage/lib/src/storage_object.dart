...
final class StorageObject {
  ...
  /// Rewrites this [Google Cloud Storage object][] to a [destinationObject] in
  /// the [destinationBucket].
  ///
  /// If [destinationBucket] is not specified, the object is rewritten within
  /// the same bucket.
  ///
