...
final class TestAllTypesProto3 extends ProtoMessage {
  ...
  Object toJson() => {
    ...
    'oneofUint32': ?oneofUint32,
    'oneofNestedMessage': ?oneofNestedMessage?.toJson(),
    'oneofString': ?oneofString,
    if (oneofBytes case final $1?) 'oneofBytes': encodeBytes($1),
    'oneofBool': ?oneofBool,
    'oneofUint64': ?oneofUint64?.toString(),
    if (oneofFloat case final $1?) 'oneofFloat': encodeDouble($1),
    if (oneofDouble case final $1?) 'oneofDouble': encodeDouble($1),
    'oneofEnum': ?oneofEnum?.toJson(),
    if (oneofNullValue case final $1?) 'oneofNullValue': $1.toJson(),
    ...
    if (optionalValue case final $1?) 'optionalValue': $1.toJson(),
...
final class NullHypothesisProto3 extends ProtoMessage {
  ...
  factory NullHypothesisProto3.fromJson(Object? _) => NullHypothesisProto3();
...
final class EnumOnlyProto3 extends ProtoMessage {
  ...
  factory EnumOnlyProto3.fromJson(Object? _) => EnumOnlyProto3();
