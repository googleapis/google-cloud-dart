---
name: google-cloud-dns-v1-setup
description: >-
  Use this skill to help the developer get started with
  package:google_cloud_dns_v1
---

## Getting Started with package:google_cloud_dns_v1

### 1. Add the package to your pubspec.yaml

```shell
dart pub add google_cloud_dns_v1
```
...
Future<void> main() async {
  ...
  final client = policies(client: authClient);
...
Future<void> main() async {
  final client = policies.fromApiKey();
