---
name: google-cloud-tasks-v2-setup
description: >-
  Use this skill to help the developer get started with
  package:google_cloud_tasks_v2
---

## Getting Started with package:google_cloud_tasks_v2

### 1. Add the package to your pubspec.yaml

```shell
dart pub add google_cloud_tasks_v2
```
...
you want to use, e.g., `CloudTasks`.
...
Future<void> main() async {
  ...
  final client = CloudTasks(client: authClient);
...
Future<void> main() async {
  final client = CloudTasks.fromApiKey();
